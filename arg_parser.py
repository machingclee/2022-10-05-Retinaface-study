...
def get_args_parser():
    ...
    parser.add_argument('--lr', '--learning-rate', default=config.initial_lr, type=float, help='initial learning rate')
    ...
    parser.add_argument('--start_epoch', default=config.start_epoch, type=int, help='resume iter for retraining')
