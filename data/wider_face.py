...
class WiderFaceDetection(data.Dataset):
    def __init__(self, txt_path, img_dir, preproc: Optional[preproc] = None, mode="train"):
        ...
        for line in lines:
            ...
            if line.startswith('#'):
                if isFirst is True:
                    ...
                    labels.clear()
                path = line[2:]
                path = os.path.join(img_dir, os.path.normpath(path))
    ...
    def __getitem__(self, index):
        pil_img = Image.open(self.imgs_path[index])
